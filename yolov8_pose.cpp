...
bool Yolov8Pose::ReadModel(cv::dnn::Net &net, std::string &netPath,
                           bool isCuda = false) {
  try {
...
bool Yolov8Pose::Detect(cv::Mat &srcImg, cv::dnn::Net &net,
  ...
  net.forward(net_output_img, net.getUnconnectedOutLayersNames()); // get
                                                                   // outputs
